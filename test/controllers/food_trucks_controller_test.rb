...
class FoodTrucksControllerTest < ActionController::TestCase
  ...
  test "should create food_truck" do
    assert_difference('FoodTruck.count') do
      post :create, food_truck: { foodTruckID: @food_truck.foodTruckID, latitude: @food_truck.latitude, longitude: @food_truck.longitude, merchantUserEmail: @food_truck.merchantUserEmail, name: @food_truck.name, type: @food_truck.type }
    end
  ...
  test "should update food_truck" do
    patch :update, id: @food_truck, food_truck: { foodTruckID: @food_truck.foodTruckID, latitude: @food_truck.latitude, longitude: @food_truck.longitude, merchantUserEmail: @food_truck.merchantUserEmail, name: @food_truck.name, type: @food_truck.type }
    assert_redirected_to food_truck_path(assigns(:food_truck))
  end
